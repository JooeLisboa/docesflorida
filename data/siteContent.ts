  ...
  products: [
    {
      ...
      description:
        "Casca nobre, recheio cremoso e finalização elegante para presentear com sofisticação.",
      image: "/images/product-ovo.png",
    ...
    },
    {
      ...
      description:
        "Seleção artesanal com sabores clássicos e autorais, ideal para compartilhar afeto.",
      image: "/images/product-brigadeiro.png",
    ...
    },
    {
      ...
      description:
        "Combinação exclusiva para uma experiência delicada, doce e memorável.",
...
export const getWhatsAppLink = (message?: string) => {
  const text = encodeURIComponent(
    message ?? siteContent.contact.prefilledMessage,
  );
